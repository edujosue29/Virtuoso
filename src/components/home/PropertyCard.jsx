  ...
  return (
    <motion.article
      ...
      style={{
        ...
        background: '#ffffff',
        cursor: 'pointer',
        boxShadow: '0 4px 32px rgba(23,60,28,0.09), 0 1px 4px rgba(23,60,28,0.06)',
        display: 'grid',
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            color: 'rgba(23,60,28,0.38)', marginBottom: '0.6rem',
          }}>
          ...
          <h2 style={{
            ...
            {nameRest && <span style={{ color: '#173C1C' }}> {nameRest}</span>}
          </h2>
          ...
          <p style={{
            ...
            color: 'rgba(23,60,28,0.45)', lineHeight: 1.6,
          ...
          <p style={{
            ...
            color: 'rgba(23,60,28,0.5)', lineHeight: 1.9,
            display: '-webkit-box',
        ...
        <div style={{
          ...
          marginTop: '2rem',
          paddingTop: '1.5rem',
          borderTop: '1px solid rgba(23,60,28,0.07)',
        }}>
          <motion.button
            ...
            style={{
              ...
              color: 'rgba(23,60,28,0.45)',
              background: 'transparent',
              border: '1px solid rgba(23,60,28,0.15)',
              borderRadius: 999,
          ...
          <motion.button
            ...
            style={{
              ...
              textTransform: 'uppercase',
              color: '#ffffff',
              background: 'linear-gradient(135deg, #173C1C, #1f4d24)',
...
function ImagePanel({ property }) {
  return (
    <div style={{
      ...
      <div style={{
        position: 'absolute', inset: 0,
        background: 'linear-gradient(to bottom, rgba(23,60,28,0.05) 0%, rgba(23,60,28,0.55) 100%)',
      }} />
      {/* Location badge */}
      <div style={{
