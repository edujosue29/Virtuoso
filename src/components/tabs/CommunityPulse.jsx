...
function ActivityItem({ act, index, dark }) {
  const text     = dark ? 'rgba(245,240,232,0.82)' : '#173C1C'
  const border   = dark ? 'rgba(245,240,232,0.07)'  : 'rgba(23,60,28,0.06)'
...
export default function CommunityPulse({ property, dark }) {
  ...
  const textStrong = dark ? 'rgba(245,240,232,0.85)'  : 'rgba(23,60,28,0.78)'
  const textMid    = dark ? 'rgba(245,240,232,0.65)'  : 'rgba(23,60,28,0.52)'
  const textSoft   = dark ? 'rgba(245,240,232,0.52)'  : 'rgba(23,60,28,0.65)'
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', minHeight: 480 }}>
          ...
          <div style={{
            position: 'absolute', inset: 0,
            background: 'linear-gradient(to bottom, rgba(23,60,28,0.1) 0%, rgba(23,60,28,0.55) 100%)',
          }} />
          {/* Bottom badge */}
          <div style={{
