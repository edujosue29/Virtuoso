...
export default function CustodyLegacy({ property, dark }) {
  ...
  const quoteColor  = dark ? 'rgba(245,240,232,0.8)'   : 'rgba(17,26,16,0.75)'
  const bodyColor   = dark ? 'rgba(245,240,232,0.72)'  : '#111a10'
  const attrColor   = dark ? 'rgba(245,240,232,0.35)'  : 'rgba(17,26,16,0.35)'
  const ctaColor    = dark ? 'rgba(245,240,232,0.45)'  : 'rgba(17,26,16,0.38)'
