  ...
  return (
    ...
    >
      <span style={{
        ...
        fontWeight: 300, color: '#173C1C', lineHeight: 1,
      }}>
        {value}
      </span>
      <span style={{
      ...
      {sub && (
        <span style={{
          fontFamily: '"Cormorant Garamond", serif',
          fontSize: '0.9rem', color: 'rgba(23,60,28,0.42)',
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        gap: '2rem',
        padding: '1.5rem 0',
        borderBottom: '1px solid rgba(23,60,28,0.06)',
        alignItems: 'start',
      }}
    >
      <span style={{
...
export default function TechnicalSheet({ property }) {
  ...
  return (
    <div>
        ...
        >
          {(() => {
            ...
            return <>
              ...
              {parts.length > 1 && <span style={{ color: '#173C1C' }}> {parts.slice(1).join(' ')}</span>}
            </>
          })()}
        </motion.h2>
      ...
      {/* ── Detailed specs list ──────────────────────────────────────────── */}
      <div style={{ borderTop: '1px solid rgba(23,60,28,0.06)' }}>
        {specs.map((row, i) => (
      ...
      <p style={{
        ...
        color: 'rgba(23,60,28,0.25)', fontFamily: 'Inter, sans-serif',
