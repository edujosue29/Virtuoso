  ...
  return (
    ...
    >
      <div style={{ position: 'relative', width: 116, height: 116 }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            color: isActive ? '#c9a84c' : '#31572C',
            lineHeight: 1, transition: 'color 0.25s',
          }}>
            {score}
          </span>
          <span style={{
            color: isActive ? '#c9a84c' : 'rgba(49,87,44,0.35)',
      ...
      <span style={{
        ...
        color: isActive ? '#31572C' : 'rgba(49,87,44,0.55)',
    ...
    <div>
      ...
      <div style={{
        ...
        >
          ...
          <span style={{ color: '#31572C' }}> Virtuoso</span>
        </motion.h2>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  background: isOpen ? 'rgba(49,87,44,0.025)' : '#ffffff',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <span style={{ color: isOpen ? '#c9a84c' : 'rgba(49,87,44,0.3)', transition: 'color 0.25s' }}>
                    {pillar.icon}
                  </span>
                  <span style={{
                    fontFamily: '"Cormorant Garamond", serif',
                    ...
                    fontWeight: 300,
                    color: isOpen ? '#31572C' : 'rgba(49,87,44,0.6)',
                    transition: 'color 0.25s',
                  }}>
                    {pillar.label}
                  </span>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', minWidth: 72 }}>
                  <span style={{
                    ...
                    letterSpacing: '0.14em', textTransform: 'uppercase',
                    color: isOpen ? '#c9a84c' : 'rgba(49,87,44,0.22)',
                    transition: 'color 0.25s',
                  }}>
                    {isOpen ? 'Cerrar' : 'Leer'}
                  </span>
                ...
                {isOpen && desc && (
                  ...
                  >
                    <div style={{
                      ...
                      background: 'rgba(49,87,44,0.025)',
                      borderLeft: '3px solid #c9a84c',
                    }}>
                      <p style={{
                        fontFamily: '"Cormorant Garamond", serif',
                        fontSize: '1.02rem', fontWeight: 300,
                        color: 'rgba(49,87,44,0.65)', lineHeight: 1.9,
                        maxWidth: 680,
                      }}>
                        {desc}
                      </p>
      ...
      <p style={{
        ...
        color: 'rgba(49,87,44,0.2)', lineHeight: 1.8, textAlign: 'center',
