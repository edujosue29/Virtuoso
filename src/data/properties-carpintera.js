    ...
    fincas: [
      {
        ...
        technical: {
          ...
          elevation:     'Elevaciones entre 1,550 y 1,800 msnm en una transición inigualable hacia el ecosistema de Bosque Muy Húmedo Montano Bajo.',
          climate:       'Clima de "eterna primavera" que promedia los 18°C y oscila a lo largo del año entre los 14°C y 24°C. Condiciones microclimáticas únicas resultado de la altitud, la neblina constante y la cobertura forestal que regula la temperatura de forma natural, sin extremos de calor ni frío que afecten la biodiversidad.',
          zoning:        'Zona Protectora Cerros de la Carpintera — SINAC/MINAE · Uso: Conservación del Agua y Biodiversidad',
          water:         'Posee naciente de agua sin registrar en zona alta. Se beneficia de servidumbre de acueducto (tanque municipal). Permisos regulados bajo Expediente MINAE N. 7479-A. Se ubica en zona de alta carga hídrica para el Valle Central.',
          biodiversity:  '250+ especies de aves (quetzal, jilguero, tucancillo) · Pumas, osos perezosos de dos dedos · Flora endémica (orquídeas, helechos arborescentes) · Corredor biológico vital · Sumidero de carbono activo',
          constructionPotential: 'La amplia zona abierta de 60% de la propiedad representa una ventaja competitiva excepcional. Permite planificación y construcción de infraestructura hasta 10% del terreno: centros de capacitación, residencias de baja densidad, laboratorios.',
          access:        'Carretera asfaltada hasta 400m del portón. Últimos 400m lastre apto para 4×4. Logística eficiente: 2 km (10 min) San Rafael · 12 km Cartago · 22 km (45 min) San José.',
          infrastructure: 'Operatividad sostenible: paneles solares (25kW) · Starlink · Cobertura celular excelente · Agua potable · Dos unidades habitacionales · Bodegas',
          ...
          soilType:      'Relieve quebrado e irregular · Bosque Muy Húmedo Montano Bajo',
          restrictions:  'Plan General de Manejo ZPCC · Ley Forestal 7575 · Exonerado Impuesto IBI · Elegible PSA FONAFIFO',
          security:      'Aislamiento topográfico absoluto · Uso de suelo regulado por MINAE/SINAC · Protección contra urbanización garantizada',
      ...
      },
      {
        ...
        technical: {
          ...
          elevation:     'Elevaciones entre 1,650 y 1,720 msnm. Ubicación estratégica en el corazón del ecosistema de Bosque Muy Húmedo Montano Bajo, con mayor densidad boscosa que la Finca 1.',
          climate:       'Clima de Bosque Muy Húmedo Montano Bajo con temperaturas constantes entre 14°C y 24°C. Promedio de lluvias anuales entre 2,000 mm y 2,500 mm. Se beneficia enormemente de la "lluvia horizontal", producto de la constante neblina que hidrata el bosque durante la estación seca, creando un microclima húmedo y estable ideal para regeneración forestal y especies sensibles a sequía.',
          ...
          water:         'Agua de manantial con tratamiento propio. Naciente propia en zona baja. Suministro garantizado legalmente mediante servidumbre de acueducto vinculada a Finca 1 (Expediente MINAE N. 7479-A).',
          biodiversity:  '250+ especies de aves · Pumas, osos perezosos, orquídeas, roble blanco · Corredor biológico vital de máxima densidad · Sumidero de carbono activo',
          soilPurity:    '12 años libre de agroquímicos. Pureza química inigualable como plataforma operativa. Elegible para certificación Agricultura Orgánica y Santuario de Biodiversidad.',
          constructionPotential: 'Ideal para proyectos integración de bienestar. Suelo puro de desarrollo sostenible. Certificaciones ecológicas accesibles inmediatamente.',
          access:        'Carretera asfaltada con 400m finales en lastre privado (4×4). Mismas distancias estratégicas: 10 min San Rafael · Menos de 1 hora Aeropuerto Internacional Juan Santamaría.',
          infrastructure: 'Infraestructura con huella de carbono cero: energía 100% solar · Starlink · Cobertura celular buena · Agua potable de manantial · Vivero orgánico sin agroquímicos · Estanques fauna y apicultura',
          ...
          soilType:      'Relieve quebrado e irregular · Bosque Muy Húmedo Montano Bajo',
          restrictions:  'Plan General de Manejo ZPCC · Ley Forestal 7575 · Exonerado IBI · Elegible PSA FONAFIFO',
          security:      'Custodia presencial activa desde 2016 · Protección contra tala y caza ilegal · Atmósfera de silencio y paz profunda · Aislamiento total',
