    ...
    fincas: [
      {
        ...
        technical: {
          ...
          elevation:     '1,550–1,800 msnm. Transición hacia Bosque Muy Húmedo Montano Bajo.',
          climate:       'Clima "eterna primavera": 18°C promedio, oscilando entre 14–24°C. Condiciones microclimáticas reguladas naturalmente por altitud y cobertura forestal.',
          zoning:        'Zona Protectora Cerros de la Carpintera — SINAC/MINAE · Uso: Conservación del Agua y Biodiversidad',
          water:         'Naciente propia sin registrar en zona alta. Servidumbre de acueducto municipal. Exp. MINAE 7479-A. Alta carga hídrica para el Valle Central.',
          biodiversity:  '250+ especies de aves (quetzales, jilgueros, tucancillos). Pumas, osos perezosos. Flora endémica (orquídeas, helechos). Corredor biológico vital y sumidero de carbono.',
          constructionPotential: '60% del área disponible permite hasta 10% construcción. Ideal para centros de capacitación, residencias de baja densidad, laboratorios.',
          access:        'Carretera asfaltada hasta 400m del portón. Último tramo lastre (4×4). A 2 km de San Rafael, 12 km de Cartago, 22 km de San José.',
          infrastructure: 'Paneles solares, Starlink, cobertura celular, agua potable. Dos unidades habitacionales y bodegas.',
          security:      'Aislamiento topográfico. Uso de suelo regulado MINAE/SINAC. Protección garantizada contra urbanización.',
      ...
      },
      {
        ...
        dueDiligence: 'https://raxqx36bylqlnogp.public.blob.vercel-storage.com/debida-diligencia-es.pdf',
        technical: {
          area:          '2.78 ha (27,848.74 m²) en San Rafael de La Unión, Cartago. Reserva natural de bajo impacto, corazón ecológico del corredor biológico.',
          areaDesglose:  '85–90% cobertura forestal densa (2.36 ha de bosque puro). Restauración ecosistémica sin intervención química en 10+ años.',
          elevation:     '1,650–1,720 msnm. Ecosistema Bosque Muy Húmedo Montano Bajo con mayor densidad boscosa que Finca 1.',
          climate:       'Temperaturas constantes 14–24°C. Lluvias 2,000–2,500 mm anuales. Lluvia horizontal por neblina crea microclima húmedo ideal para regeneración forestal.',
          zoning:        'Zona Protectora Cerros de la Carpintera — SINAC/MINAE. Para Conservación del Agua y Biodiversidad.',
          water:         'Agua de manantial con tratamiento propio. Naciente en zona baja. Servidumbre de acueducto vinculada a Finca 1 (Exp. 7479-A MINAE).',
          biodiversity:  '250+ especies de aves. Pumas, osos perezosos, orquídeas, roble blanco. Corredor biológico de máxima densidad y sumidero de carbono.',
          soilPurity:    '10+ años libre de agroquímicos. Elegible para certificación Agricultura Orgánica o Santuario de Biodiversidad.',
          constructionPotential: 'Ideal para proyectos de bienestar e integración. Suelo puro sin intervención agrícola intensiva.',
          access:        'Vía asfaltada + 400m lastre privado (4×4). A 10 min San Rafael, menos de 1 hora del Aeropuerto Internacional.',
          infrastructure: 'Huella de carbono cero: 100% solar, Starlink, cobertura celular, agua de manantial, vivero orgánico, estanques de fauna.',
          security:      'Custodia presencial desde 2016 contra tala y caza. Alta densidad forestal crea silencio, paz y aislamiento total.',
          value:         '$345,000 USD solicitado · $410,000 USD valor mercado',
          legalStatus:   'Sin hipotecas ni gravámenes. Exoneración IBI. Elegible PSA FONAFIFO.',
        },
        prosperity: {
